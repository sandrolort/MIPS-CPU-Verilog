...
lappend arg_list "--report-file=csv:fpga_lpddr2_example.csv"
lappend arg_list "--report-file=qip:fpga_lpddr2_example.qip"
lappend arg_list "--output-name=fpga_lpddr2_example"
...
lappend arg_list "--component-param=EXPORT_AFI_HALF_CLK=true"
...
lappend arg_list "--component-param=HARD_EMIF=true"
...
lappend arg_list "--component-param=MEM_CLK_FREQ=330.0"
lappend arg_list "--component-param=MEM_CLK_FREQ_MAX=400.0"
...
lappend arg_list "--component-param=MEM_DQ_WIDTH=32"
lappend arg_list "--component-param=MEM_DRV_STR=40"
...
lappend arg_list "--component-param=MEM_TFAW_NS=50.0"
lappend arg_list "--component-param=MEM_TINIT_US=200"
lappend arg_list "--component-param=MEM_TMRD_CK=2"
lappend arg_list "--component-param=MEM_TRAS_NS=70.0"
lappend arg_list "--component-param=MEM_TRCD_NS=18.0"
lappend arg_list "--component-param=MEM_TREFI_US=3.9"
lappend arg_list "--component-param=MEM_TRFC_NS=60.0"
lappend arg_list "--component-param=MEM_TRP_NS=18.0"
lappend arg_list "--component-param=MEM_TRRD_NS=10.0"
lappend arg_list "--component-param=MEM_TRTP_NS=7.5"
lappend arg_list "--component-param=MEM_TWR_NS=15.0"
lappend arg_list "--component-param=MEM_TWTR=2"
...
lappend arg_list "--component-param=TIMING_BOARD_MAX_CK_DELAY=0.33"
lappend arg_list "--component-param=TIMING_BOARD_MAX_DQS_DELAY=0.34"
...
lappend arg_list "--component-param=TIMING_TDH=270"
lappend arg_list "--component-param=TIMING_TDQSCK=5500"
...
lappend arg_list "--component-param=TIMING_TDQSH=0.4"
lappend arg_list "--component-param=TIMING_TDQSQ=240"
lappend arg_list "--component-param=TIMING_TDQSS=1.0"
lappend arg_list "--component-param=TIMING_TDS=270"
lappend arg_list "--component-param=TIMING_TDSH=0.2"
lappend arg_list "--component-param=TIMING_TDSS=0.2"
lappend arg_list "--component-param=TIMING_TIH=290"
lappend arg_list "--component-param=TIMING_TIS=290"
lappend arg_list "--component-param=TIMING_TQHS=280"
...
catch { eval [concat [list exec "C:/altera/13.1/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_lpddr2_tg_ed] $arg_list] } temp
puts $temp
