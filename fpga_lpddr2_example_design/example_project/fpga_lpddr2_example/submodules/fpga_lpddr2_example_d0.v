...
module fpga_lpddr2_example_d0 #(
		...
		output wire [28:0] avl_addr,        //          .address
	...
	generate
		...
		if (DRIVER_SIGNATURE != 1431634051)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
