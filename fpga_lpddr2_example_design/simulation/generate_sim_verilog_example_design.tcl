if {[is_project_open]} {
	...
	if {[string compare $project_name "generate_sim_example_design"] != 0} {
		...
		post_message -type error "in the directory fpga_lpddr2_example_design/simulation/"
		return 1
	}
}
set variant_name fpga_lpddr2_example_sim
set arg_list [list]
...
catch {eval [concat [list exec "$qdir/sopc_builder/bin/ip-generate" --component-name=alt_mem_if_lpddr2_tg_eds] $arg_list]} temp
puts $temp
