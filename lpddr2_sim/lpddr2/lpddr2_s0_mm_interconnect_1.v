...
`timescale 1 ps / 1 ps
module lpddr2_s0_mm_interconnect_1 (
	...
	lpddr2_s0_mm_interconnect_1_router router (
	...
	lpddr2_s0_mm_interconnect_1_router_001 router_001 (
	...
	lpddr2_s0_mm_interconnect_1_router_001 router_002 (
	...
	lpddr2_s0_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (avl_clk_out_clk_clk),                             //        clk.clk
		.reset              (trk_mm_bridge_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	lpddr2_s0_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (avl_clk_out_clk_clk),                             //       clk.clk
		.reset               (trk_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lpddr2_s0_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (avl_clk_out_clk_clk),                             //       clk.clk
		.reset               (trk_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lpddr2_s0_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (avl_clk_out_clk_clk),                             //       clk.clk
		.reset              (trk_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lpddr2_s0_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (avl_clk_out_clk_clk),                             //       clk.clk
		.reset              (trk_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lpddr2_s0_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (avl_clk_out_clk_clk),                             //       clk.clk
		.reset               (trk_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
