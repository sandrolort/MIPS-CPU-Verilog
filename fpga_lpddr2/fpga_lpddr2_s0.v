...
// 
// Generated using ACDS version 13.1 162 at 2014.06.23.16:21:44

`timescale 1 ps / 1 ps
module fpga_lpddr2_s0 (
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (13312),
		.INIT_FILE        ("fpga_lpddr2_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	fpga_lpddr2_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	fpga_lpddr2_s0_mm_interconnect_1 mm_interconnect_1 (
		.avl_clk_out_clk_clk                             (avl_clk),                                                   //                           avl_clk_out_clk.clk
	...
	fpga_lpddr2_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
